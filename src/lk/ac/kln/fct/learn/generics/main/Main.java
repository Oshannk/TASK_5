...
public class Main {
    ...
    public static void inventoryTest_03() {
        ...
        Inventory<String, Object> inventory = new Inventory<>();
        Entry<String, Object> entry1 = new Entry<>("Entry1", 10.1);
        Entry<String, Object> entry2 = new Entry<>("Entry2", 10.2);
        Entry<String, Object> entry3 = new Entry<>("Entry3", 10.3);
        Entry<String, Object> entry4 = new Entry<>("Entry4", 10.4);
        Entry<String, Object> entry5 = new Entry<>("Entry5", 10.5);
